...
ion-chain-gas-flow is a C project for blockchain tooling. It focuses on this technical goal: Implement a C blockchain tooling project for gas constraint solving, using bounded scenario files and conflict explanations.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 184, risk penalty 4, latency penalty 4, and weight bonus 3. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
