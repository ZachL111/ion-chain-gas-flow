"""Regression checks for the ion-chain-gas-flow casebook."""
...
from casebook.harness import assert_expected, ion_chain_gas_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ion_chain_gas_flow_summary(), assert_expected())
